...
vim.keymap.set('n', '<leader>n', ':Neotree filesystem reveal left toggle <CR>', { desc = 'Open file tree focused on the currently active file' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sm', builtin.lsp_document_symbols, { desc = '[ ] Find LSP Symbols' })
